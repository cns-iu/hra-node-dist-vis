...
function* getClosest(sources, sourceIndexes, targets, maxDistSquared) {
...
export function* distanceEdges(nodes, type_field, target_type, maxDist) {
  const source_cells = {};
  const target_cells = {};
